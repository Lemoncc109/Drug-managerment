...
public class ReturnsupplierServiceImpl extends ServiceImpl<ReturnsupplierMapper, Returnsupplier> implements IReturnsupplierService {
     ...
     */
    @Override
    public IPage<Returnsupplier> selectReturnsupplierPage(Integer page,Integer limit,String param) {
        QueryWrapper<Returnsupplier> queryWrapper = new QueryWrapper<>();
        if(StringUtils.isNotEmpty(param)){
            queryWrapper.like("dname",param);
        }
        Page<Returnsupplier> page1 = new Page<>(page,limit);
        return returnsupplierMapper.selectPage(page1,queryWrapper);
    }
