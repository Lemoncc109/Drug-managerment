...
public class SupplierController {
    ...
    @ResponseBody
    public Object supplierQueryPage(String param, @RequestParam(value = "page", defaultValue = "1")Integer page,@RequestParam(value = "limit",defaultValue = "10")Integer limit){
        try{
