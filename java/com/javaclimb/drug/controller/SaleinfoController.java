...
public class SaleinfoController {
    ...
    @ResponseBody
    public Object saleinfoQueryPage(String param, @RequestParam(value = "page", defaultValue = "1")Integer page,@RequestParam(value = "limit",defaultValue = "10")Integer limit){
        try{
